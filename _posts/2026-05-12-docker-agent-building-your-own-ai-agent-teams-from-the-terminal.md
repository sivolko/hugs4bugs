...
optimized_image: https://i.pinimg.com/736x/8b/81/38/8b8138c4491769dd53c5dc09b6548ecf.jpg
...
**Use `todo` toolset for anything multi-step.** When you ask for something that takes more than one action, the todo toolset lets the agent track its own progress. You can actually watch it work through a checklist.
